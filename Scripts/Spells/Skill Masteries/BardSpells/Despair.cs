...
namespace Server.Spells.SkillMasteries
{
	public class DespairSpell : BardSpell
	{
		...
		public void OnTarget(Mobile m)
		{
			...
			{
				Caster.SendMessage("This Spell cannot be cast on one's self...");
			}
			...
			else if (CheckHSequence(m))
			{
				...
				// This buff indicates physical damage, which is incorrect
		...
		public override bool OnTick()
		{
			...
			var elementType = BookOfMasteries.GetDespairElementType(Caster);
			var physicalDamage = elementType == Mobiles.ElementType.Physical ? 100 : 0;
			var fireDamage = elementType == Mobiles.ElementType.Fire ? 100 : 0;
			var poisonDamage = elementType == Mobiles.ElementType.Poison ? 100 : 0;
			var energyDamage = elementType == Mobiles.ElementType.Energy ? 100 : 0;
			var coldDamage = elementType == Mobiles.ElementType.Cold ? 100 : 0;

			AOS.Damage(Target, Caster, damage, physicalDamage, fireDamage, coldDamage, poisonDamage, energyDamage);
