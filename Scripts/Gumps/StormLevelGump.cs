...
namespace Server.Gumps
{
    ...
    public class StormLevelGump : Gump
    {
        ...
        private static void OnLogin(LoginEventArgs e)
        {
            ...
            if (((from.Map == Map.Trammel && from.Region.IsPartOf("Blackthorn Castle")) || Engines.Fellowship.ForsakenFoesEvent.Instance.Running && from.Region.IsPartOf("BlackthornDungeon") || from.Region.IsPartOf("Ver Lor Reg")) && from.Player && from.AccessLevel < AccessLevel.Counselor && from.CharacterOut)
            {
