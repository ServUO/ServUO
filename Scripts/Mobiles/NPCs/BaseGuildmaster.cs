...
namespace Server.Mobiles
{
    public abstract class BaseGuildmaster : BaseVendor
    {
        ...
        {
            m.Send(new MessageLocalizedAffix(this.Serial, this.Body, MessageType.Regular, this.SpeechHue, 3, 1008052, this.Name, AffixType.Append, this.JoinCost.ToString(), "", false));
        }
