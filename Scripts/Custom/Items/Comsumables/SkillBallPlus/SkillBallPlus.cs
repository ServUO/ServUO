									...
									if (info.IsSwitched(i))
										switch ((SkillName)i)
										{
											...
											case SkillName.Magery:
												...
												pack.DropItem(new BagOfReagents(100));
												break;
											...
											case SkillName.TasteID:
												pack.DropItem(new GreaterHealPotion());
												pack.DropItem(new GreaterAgilityPotion());
												pack.DropItem(new GreaterStrengthPotion());
												break;
