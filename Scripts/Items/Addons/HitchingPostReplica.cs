...
namespace Server.Items
{
    ...
    public class HitchingPostReplica : Item, ISecurable
    {
        ...
        public HitchingPostReplica(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            private readonly HitchingPostReplica m_Post;
            private readonly Mobile m_From;

            public StableEntry(HitchingPostReplica post, Mobile from)
                : base(6126, 12)
            {
                this.m_Post = post;
                this.m_From = from;
        ...
        private class ClaimListGump : Gump
        {
            ...
            public ClaimListGump(HitchingPostReplica post, Mobile from, List<BaseCreature> list)
                : base(50, 50)
            {
                this.m_Post = post;
                this.m_From = from;
        ...
        private class StableTarget : Target
        {
            ...
            public StableTarget(HitchingPostReplica post)
