            ...
            this.Definition =
                new FactionDefinition(
                    ...
                    /*new StrongholdDefinition(
                        new Rectangle2D[]
                        {
                            new Rectangle2D(4465, 1523, 20, 46),
                        },
                        new Point3D(4468, 1494, 0),
                        new Point3D(4457, 1544, 0),
                        new Point3D[]
                        {
                            new Point3D(4464, 1537, 21),
                            new Point3D(4466, 1537, 21),
                            new Point3D(4468, 1537, 21),
                            new Point3D(4470, 1537, 21),
                            new Point3D(4464, 1533, 21),
                            new Point3D(4466, 1533, 21),
                            new Point3D(4468, 1533, 21),
                            new Point3D(4470, 1533, 21),
                        })*/
                    : // Old CoM Location
                    new StrongholdDefinition(
                        new Rectangle2D[]
