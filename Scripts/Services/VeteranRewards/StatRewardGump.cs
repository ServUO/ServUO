...
namespace Server.Engines.VeteranRewards
{
    public class StatRewardGump : BaseGump
    {
        ...
        public override void AddGumpLayout()
        {
            ...
            int interval = (int)(RewardSystem.RewardInterval.TotalDays / 2);
            string time = interval == 1 ? "day" : "days";

            if (interval > 30)
            {
                interval /= 30;
                time = interval == 1 ? "month" : "months";
            }

            AddHtml(7, 7, 277, 126, Color("#FFFFFF", String.Format(_Label, interval.ToString(), time)), false, false);
        ...
        private string _Label = "<B>Ultima Online Rewards Program</B><BR>Thank you for being part of the Ultima Online community for over {0} {1}. As a token of our appreciation, your stat cap will be increased.";
