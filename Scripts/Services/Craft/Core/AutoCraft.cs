...
namespace Server.Engines.Craft
{
    ...
    public class AutoCraftTimer : Timer
    {
        ...
        public AutoCraftTimer(Mobile from, CraftSystem system, CraftItem item, IUsesRemaining tool, int amount) : this(from,system,item,tool,amount,TimeSpan.FromSeconds(2.5), TimeSpan.FromSeconds(2.5))
        {
        }
