...
namespace Server.Items
{
    ...
    /*public class BaseDailyRare : Item
    {
        [CommandProperty(AccessLevel.GameMaster)]
        public bool HasMoved { get; set; }

        public BaseDailyRare(int itemID)
            : base(itemID)
        {
            CanMove = false;
        }
        ...
        public BaseDailyRare(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            HasBeenMoved = reader.ReadBool();
            CanMove = reader.ReadBoom();
        }
    }

    public class BaseDailyRareFood : Food
    {
        public bool HasBeenMoved { get; set; }
        public bool CanMove { get; set; }

        public BaseDailyRareFood(int itemID)
            : base(itemID)
        {
            CanMove = true;
        }
        ...
        public BaseDailyRareFood(Serial serial)
            : base(serial)
        {
        }
