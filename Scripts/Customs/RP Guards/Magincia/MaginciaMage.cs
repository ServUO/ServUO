...
{ 
	public class MaginciaMage : BaseRanger 
	{ 

		[Constructable] 
		public MaginciaMage() : base( AIType.AI_Mage, FightMode.Weakest, 10, 5, 0.1, 0.2 ) 
		{ 
			Title = "the Mage"; 
		...
		public MaginciaMage( Serial serial ) : base( serial ) 
		{ 
		} 
