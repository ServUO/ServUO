...
{ 
	public class MaginciaArcher : BaseRanger
	{ 


		[Constructable] 
		public MaginciaArcher() : base( AIType.AI_Archer, FightMode.Weakest, 15, 5, 0.1, 0.2 ) 
		{ 
			Title = "the Ranger"; 
		...
		public MaginciaArcher( Serial serial ) : base( serial ) 
		{ 
		} 
