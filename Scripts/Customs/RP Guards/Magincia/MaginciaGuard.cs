...
{ 
	public class MaginciaGuard : BaseRanger
	{ 

		[Constructable] 
		public MaginciaGuard() : base( AIType.AI_Melee, FightMode.Closest, 15, 1, 0.1, 0.2 ) 
		{ 
			Title = "the Guard"; 
		...
		public MaginciaGuard( Serial serial ) : base( serial ) 
		{ 
		} 
