...
{ 
	public class DeluciaArcher : BaseRanger
	{ 


		[Constructable] 
		public DeluciaArcher() : base( AIType.AI_Archer, FightMode.Weakest, 15, 5, 0.1, 0.2 ) 
		{ 
			Title = "the Archer"; 
		...
		public DeluciaArcher( Serial serial ) : base( serial ) 
		{ 
		} 
