...
{ 
	public class TrinsicGuard : BaseRanger
	{ 

		[Constructable] 
		public TrinsicGuard() : base( AIType.AI_Melee, FightMode.Closest, 15, 1, 0.1, 0.2 ) 
		{ 
			Title = "the Swordsman"; 
		...
		public TrinsicGuard( Serial serial ) : base( serial ) 
		{ 
		} 
