...
{ 
	public class NujelmArcher : BaseRanger
	{ 


		[Constructable] 
		public NujelmArcher() : base( AIType.AI_Archer, FightMode.Weakest, 15, 5, 0.1, 0.2 ) 
		{ 
			Title = "the Ranger"; 
		...
		public NujelmArcher( Serial serial ) : base( serial ) 
		{ 
		} 
