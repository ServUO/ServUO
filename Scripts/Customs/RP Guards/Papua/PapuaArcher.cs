...
{ 
	public class PapuaArcher : BaseRanger
	{ 


		[Constructable] 
		public PapuaArcher() : base( AIType.AI_Archer, FightMode.Weakest, 15, 5, 0.1, 0.2 ) 
		{ 
			Title = "the Ranger"; 
		...
		public PapuaArcher( Serial serial ) : base( serial ) 
		{ 
		} 
