			...
			protected override void OnTarget( Mobile from, object targeted )
			{
				...
				if ( targeted != null && targeted is Arrow )
				{
					if ( it_Tub != null )
					{
						...
						from.SendMessage( "You carefully apply the cold piercing material to your bundle of arrows." );
							
						it_Tub.Charges--;
						arrow.Consume( amount );
						//Note: pack.ConsumeTotal( typeof(Arrow), 20 )
						from.AddToBackpack( new FreezeArrow( amount ) );
				...
				else if ( targeted != null && targeted is Bolt )
				{
					if ( it_Tub != null )
					{
						...
						from.SendMessage( "You carefully apply the cold piercing material to your bundle of bolts." );
							
						it_Tub.Charges--;
						bolt.Consume( amount );
						//Note: pack.ConsumeTotal( typeof(Arrow), 20 )
						from.AddToBackpack( new FreezeBolt( amount ) );
