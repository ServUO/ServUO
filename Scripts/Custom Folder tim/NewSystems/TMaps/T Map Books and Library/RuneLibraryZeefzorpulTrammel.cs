...
//  
//	
//  Zeefzorpul Lovations Ver. 1.0 
//  
//  Based on Runebook T-Hunting Files Original Ideas and code by // A_Li_N // Senior Member
//  
//  Love the script!  Tukaram added Zeefzorpul locations 6JAN15
...
{
		public class RuneLibraryZeefzorpulTrammel : Item
	{
		private static string pathlist = "Data/RuneLibraryZeefzorpul.txt";
      ...
      {
         CommandSystem.Register( "RuneLibraryZeefzorpulTrammel", AccessLevel.Administrator, new CommandEventHandler( RuneLibraryZeefzorpulTrammel_OnCommand ) );
      }

		public static void RuneLibraryZeefzorpulTrammel_OnCommand( CommandEventArgs args )
		{
			Mobile m = args.Mobile;
         RuneLibraryZeefzorpulTrammel rl = new RuneLibraryZeefzorpulTrammel(m);
		}
		...
		[Constructable]
		public RuneLibraryZeefzorpulTrammel (Mobile from)
		{
			...
			for( int i=0; i<size; i++ )
			{
				...
				{
					rb.Name = "Zeefzorpul Trammel " + nameStart + " - " + (nameEnd-1);
					library.Add(rb);
					rb = new Runebook(0);
					nameStart = nameEnd;
				}
		...
		public RuneLibraryZeefzorpulTrammel( Serial serial ) : base( serial )
		{
		}
