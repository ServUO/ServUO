...
{
   public class TrammelTMapAltas : Item
   {
      [Constructable]
      public TrammelTMapAltas() : base( 0x22C5 ) //old id is 0x2259
      {
         Movable = true;
         //Light = LightType.Circle300;
         //Hue = 322;
         Weight = 3;  
         Name = "Trammel T Map Atlas";
         LootType = LootType.Blessed;
         
      }

      public TrammelTMapAltas(Serial serial)
          : base(serial)
      {
      }
      ...
      public bool UseGate( Mobile m )
      {
         ...
         {
             m.CloseGump(typeof(TrammelTMapAltasGump));
             m.SendGump(new TrammelTMapAltasGump(m));
   ...
   public class PMList
   {
      ...
      public static readonly PMList Maps117 =
         new PMList( "Maps 1-17", "Maps 1-17", Map.Trammel, new PMEntry[]
            {
      ...
      public static readonly PMList Maps1834 =
         new PMList( "Maps 18-34", "Maps 18-34", Map.Trammel, new PMEntry[]
                {
      ...
      public static readonly PMList Maps3551 =
         new PMList("Maps 35-51", "Maps 35-51", Map.Trammel, new PMEntry[]
            {
      ...
      public static readonly PMList Maps5268 =
         new PMList("Maps 52-68", "Maps 52-68", Map.Trammel, new PMEntry[]
            {
      ...
      public static readonly PMList Maps6985 =
         new PMList("Maps 69-85", "Maps 69-85", Map.Trammel, new PMEntry[]
            {
      ...
      public static readonly PMList Maps86102 =
         new PMList("Maps 86-102", "Maps 86-102", Map.Trammel, new PMEntry[]
            {
      ...
      public static readonly PMList Maps103119 =
         new PMList("Maps 103-119", "Maps 103-119", Map.Trammel, new PMEntry[]
            {
      ...
      public static readonly PMList Maps120136 =
         new PMList("Maps 120-136", "Maps 120-136", Map.Trammel, new PMEntry[]
            {
      ...
      public static readonly PMList Maps137153 =
         new PMList("Maps 137-153", "Maps 137-153", Map.Trammel, new PMEntry[]
            {
      ...
      public static readonly PMList Maps154170 =
         new PMList("Maps 154-170", "Maps 154-170", Map.Trammel, new PMEntry[]
            {
      ...
      public static readonly PMList Maps171187 =
         new PMList("Maps 171-187", "Maps 171-187", Map.Trammel, new PMEntry[]
            {
      ...
      public static readonly PMList Maps188196 =
  new PMList("Maps 188-196", "Maps 188-196", Map.Trammel, new PMEntry[]
            {
        ...
        //Here you can edit what facets to show on the TravelBooks... For Tmaps I show all, just easier not to edit out section.
                public static readonly PMList[] UORLists        = new PMList[] { Maps117, Maps1834, Maps3551, Maps5268, Maps6985, Maps86102, Maps103119, Maps120136, Maps137153, Maps154170, Maps171187, Maps188196 };
                public static readonly PMList[] UORlistsYoung   = new PMList[] { Maps117, Maps1834, Maps3551, Maps5268, Maps6985, Maps86102, Maps103119, Maps120136, Maps137153, Maps154170, Maps171187, Maps188196 };
                public static readonly PMList[] LBRLists        = new PMList[] { Maps117, Maps1834, Maps3551, Maps5268, Maps6985, Maps86102, Maps103119, Maps120136, Maps137153, Maps154170, Maps171187, Maps188196 };
                public static readonly PMList[] LBRListsYoung   = new PMList[] { Maps117, Maps1834, Maps3551, Maps5268, Maps6985, Maps86102, Maps103119, Maps120136, Maps137153, Maps154170, Maps171187, Maps188196 };
                public static readonly PMList[] AOSLists        = new PMList[] { Maps117, Maps1834, Maps3551, Maps5268, Maps6985, Maps86102, Maps103119, Maps120136, Maps137153, Maps154170, Maps171187, Maps188196 };
                public static readonly PMList[] AOSListsYoung   = new PMList[] { Maps117, Maps1834, Maps3551, Maps5268, Maps6985, Maps86102, Maps103119, Maps120136, Maps137153, Maps154170, Maps171187, Maps188196 };
                public static readonly PMList[] SELists         = new PMList[] { Maps117, Maps1834, Maps3551, Maps5268, Maps6985, Maps86102, Maps103119, Maps120136, Maps137153, Maps154170, Maps171187, Maps188196 };
                public static readonly PMList[] SEListsYoung    = new PMList[] { Maps117, Maps1834, Maps3551, Maps5268, Maps6985, Maps86102, Maps103119, Maps120136, Maps137153, Maps154170, Maps171187, Maps188196 };
                public static readonly PMList[] RedLists        = new PMList[] { Maps117, Maps1834, Maps3551, Maps5268, Maps6985, Maps86102, Maps103119, Maps120136, Maps137153, Maps154170, Maps171187, Maps188196 };
                public static readonly PMList[] SigilLists      = new PMList[] { Maps117, Maps1834, Maps3551, Maps5268, Maps6985, Maps86102, Maps103119, Maps120136, Maps137153, Maps154170, Maps171187, Maps188196 };
    }

   public class TrammelTMapAltasGump : Gump
   {
      public static void Initialize()
      {
         CommandSystem.Register( "Pod2", AccessLevel.GameMaster, new CommandEventHandler( TrammelTMapAltasGump_OnCommand ) );
      }

      private static void TrammelTMapAltasGump_OnCommand( CommandEventArgs e )
      {
         e.Mobile.SendGump( new TrammelTMapAltasGump( e.Mobile ) );
      }

      private Mobile m_Mobile;
      private PMList[] m_Lists;

      public TrammelTMapAltasGump(Mobile mobile)
          : base(100, 100)
      {
         m_Mobile = mobile;
