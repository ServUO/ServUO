...
{
	public class CaptainJohnsGloves : LeatherGloves
	{
		...
		[Constructable]
		public CaptainJohnsGloves()
		{
			Hue = 0x455;
			Name = "Captain Johns Gloves [Replica]";
		...
		public CaptainJohnsGloves( Serial serial ) : base( serial )
		{
		}
