...
namespace Server.Items
{
	public class YewwoodSpirit : BaseTalisman
	{
		...
		public YewwoodSpirit() : base( 0x2F5A )
		{
			...
			SkillBonuses.SetValues( 1, SkillName.AnimalTaming, 5.0 );
		}

		public YewwoodSpirit( Serial serial ) :  base( serial )
		{
		}
