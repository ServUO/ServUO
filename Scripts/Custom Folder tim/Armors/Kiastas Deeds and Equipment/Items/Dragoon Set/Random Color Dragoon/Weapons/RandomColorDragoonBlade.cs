...
namespace Server.Kiasta
{
    ...
    public class RandomColorDragoonBlade : BaseDragoonWeapon
	{
		...
		[Constructable]
		public RandomColorDragoonBlade() : base( 0x13FF )
		{
            	Name = "Blade "+Settings.DragoonEquipmentName.Suffix;
			    Weight = 6.0;
		}

		public RandomColorDragoonBlade( Serial serial ) : base( serial )
		{
		}
