...
{
    public abstract class KiastasBaseJewel : BaseJewel
    {
        ...
        public KiastasBaseJewel(int itemID, Layer layer) : base(itemID, layer)
        {
            GemType = GemType.StarSapphire;
        }

        public KiastasBaseJewel(Serial serial) : base(serial)
        {
        }
