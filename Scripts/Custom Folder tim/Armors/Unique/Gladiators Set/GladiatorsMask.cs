...
{
	public class GladiatorsMask : CloseHelm
	{
		public override int LabelNumber{ get{ return 1094917; } } // Gladiator's Mask [Replica]
		...
		[Constructable]
		public GladiatorsMask()
		{
			Name = "Gladiators Mask [Replica]";
		...
		public GladiatorsMask( Serial serial ) : base( serial )
		{
		}
