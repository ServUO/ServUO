...
{
	public class OrcChieftainGloves : BoneGloves
	{
		...
		[Constructable]
		public OrcChieftainGloves()
		{
			Name = "Orc Chieftain Gloves [Replica]";
		...
		public OrcChieftainGloves( Serial serial ) : base( serial )
		{
		}
