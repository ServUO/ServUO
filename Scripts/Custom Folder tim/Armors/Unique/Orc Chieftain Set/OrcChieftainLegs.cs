...
{
	public class OrcChieftainLeggings : BoneLegs
	{
		...
		[Constructable]
		public OrcChieftainLeggings()
		{
			Name = "Orc Chieftain Leggings [Replica]";
		...
		public OrcChieftainLeggings( Serial serial ) : base( serial )
		{
		}
