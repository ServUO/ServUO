...
//This script was created on 6/3/2012 5:49:03 PM
//=================================================
...
{
	public class NewbieGnarledStaff : GnarledStaff
	{
		...
		[Constructable]
		public NewbieGnarledStaff()
		{
			Name = "Newbie Gnarled Staff";
			Hue = 88;
		...
		public NewbieGnarledStaff( Serial serial ) : base( serial )
		{
		}
