...
{
	public class ShipPaintingEast : BaseAddon, IRewardItem
	{
		public override BaseAddonDeed Deed
		{ 
			get
			{ 
				ShipPaintingEastDeed deed = new ShipPaintingEastDeed();
		...
		[Constructable]
		public ShipPaintingEast() : base()
		{
			AddComponent( new AddonComponent( 0x4C27 ), 0, 0, 0 );
			
			m_Timer = Timer.DelayCall( TimeSpan.FromDays( 1 ), TimeSpan.FromDays( 1 ), new TimerCallback( GiveLargePowder ) );
		}

		public ShipPaintingEast( Serial serial ) : base( serial )
		{
		}
	...
	public class ShipPaintingEastDeed : BaseAddonDeed, IRewardItem
	{
		
		
		public override int LabelNumber{ get{ return 1154181; } } //Ship Painting (East)
		public override BaseAddon Addon
		{ 
			get
			{ 
				ShipPaintingEast addon = new ShipPaintingEast();
		...
		[Constructable]
		public ShipPaintingEastDeed() 
		{
			LootType = LootType.Blessed;
		}

		public ShipPaintingEastDeed( Serial serial ) : base( serial )
		{
		}
