...
{
	public class Tools_sorcery_scroll : Item
	{
			// First circle
		...
		[Constructable]
		public Tools_sorcery_scroll() : base( 0x14F0 )
		{
		...
		public Tools_sorcery_scroll( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				from.CloseGump( typeof( Tools_sorcery_scrollGump ) );
				from.SendGump( new Tools_sorcery_scrollGump( from, this ) );
			}
		}
