...
{
	public class TacticsTrainingGump : Gump
	{
		...
		public TacticsTrainingGump() : base( 50, 50 )
		{
			...
			if (thespot == 1) this.AddImage(307, 12, 3); // placing the marker of "where to hit"
			else if (thespot == 2) this.AddImage(277, 44, 3); // placing the marker of "where to hit"
			else if (thespot == 3) this.AddImage(337, 44, 3); // placing the marker of "where to hit"
			else if (thespot == 4) this.AddImage(310, 77, 3); // placing the marker of "where to hit"
			else if (thespot == 5) this.AddImage(283, 108, 3); // placing the marker of "where to hit"
			else if (thespot == 6) this.AddImage(333, 108, 3); // placing the marker of "where to hit"
			this.AddLabel(30, 45, 33, @"When Swinging Your Weapon"); // what question to ask
			this.AddLabel(30, 75, 33, @"and trying to hit the spot shown");
			this.AddLabel(30, 105, 33, @"Which way would you swing");
			this.AddLabel(30, 135, 33, @"your weapon?");
			...
			this.AddLabel(60, 200, 33, @"From the Top & Down");
			this.AddLabel(60, 230, 33, @"From the Top Left to the Lower Right");
			this.AddLabel(60, 260, 33, @"From the Top Right to the Lower Left");
			this.AddLabel(60, 290, 33, @"Lunge/Poke/Stab");
			this.AddLabel(60, 320, 33, @"From the Left to the Right Even Swing");
			this.AddLabel(60, 350, 33, @"From the Right to the Left Even Swing");
		...
		public override void OnResponse(NetState sender, RelayInfo info )
		{
			...
			if (pm == null) return;
			pm.CheckSkill( SkillName.Tactics, 0.0, 160.0 );
