...
{ 
   public class PestilentBandageIdol : Item 
   { 
      [Constructable] 
      public PestilentBandageIdol() : base( 9639 ) 
      { 
         Movable = true; 
         Name = "Pestilent Bandage Idol"; 
         Hue = 1301;
      } 

      public PestilentBandageIdol( Serial serial ) : base( serial ) 
      { 
      } 
