...
{ 
   public class EnslavedGargoyleIdol : Item 
   { 
      [Constructable] 
      public EnslavedGargoyleIdol() : base( 9613 ) 
      { 
         Movable = true; 
         Name = "Enslaved Gargoyle Idol"; 
      } 

      public EnslavedGargoyleIdol( Serial serial ) : base( serial ) 
      { 
      } 
