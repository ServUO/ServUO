...
{ 
   public class WandererOfTheVoidIdol : Item 
   { 
      [Constructable] 
      public WandererOfTheVoidIdol() : base( 9776 ) 
      { 
         Movable = true; 
         Name = "Wanderer Of The Void Idol"; 
      } 

      public WandererOfTheVoidIdol( Serial serial ) : base( serial ) 
      { 
      } 
