...
{ 
   public class RedSolenInfiltratorQueenIdol : Item 
   { 
      [Constructable] 
      public RedSolenInfiltratorQueenIdol() : base( 9730 ) 
      { 
         Movable = true; 
         Name = "Red Solen Infiltrator Queen Idol"; 
      } 

      public RedSolenInfiltratorQueenIdol( Serial serial ) : base( serial ) 
      { 
      } 
