...
{ 
   public class ScaledSwampDragonIdol : Item 
   { 
      [Constructable] 
      public ScaledSwampDragonIdol() : base( 9753 ) 
      { 
         Movable = true; 
         Name = "Scaled Swamp Dragon Idol";  
      } 

      public ScaledSwampDragonIdol( Serial serial ) : base( serial ) 
      { 
      } 
