...
{ 
   public class TerathanWarriorIdol : Item 
   { 
      [Constructable] 
      public TerathanWarriorIdol() : base( 9676 ) 
      { 
         Movable = true; 
         Name = "Terathan Warrior Idol"; 
      } 

      public TerathanWarriorIdol( Serial serial ) : base( serial ) 
      { 
      } 
