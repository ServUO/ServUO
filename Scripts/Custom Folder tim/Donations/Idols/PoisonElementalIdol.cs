...
{ 
   public class PoisonElementalIdol : Item 
   { 
      [Constructable] 
      public PoisonElementalIdol() : base( 9691 ) 
      { 
         Movable = true; 
         Name = "Poison Elemental Idol"; 
      } 

      public PoisonElementalIdol( Serial serial ) : base( serial ) 
      { 
      } 
