...
{ 
   public class InterredGrizzleIdol : Item 
   { 
      [Constructable] 
      public InterredGrizzleIdol() : base( 6256 ) 
      { 
         Movable = true; 
         Name = "Interred Grizzle Idol"; 
      } 

      public InterredGrizzleIdol( Serial serial ) : base( serial ) 
      { 
      } 
