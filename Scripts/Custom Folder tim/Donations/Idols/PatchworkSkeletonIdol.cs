...
{ 
   public class PatchworkSkeletonIdol : Item 
   { 
      [Constructable] 
      public PatchworkSkeletonIdol() : base( 9769 ) 
      { 
         Movable = true; 
         Name = "Patchwork Skeleton Idol"; 
      } 

      public PatchworkSkeletonIdol( Serial serial ) : base( serial ) 
      { 
      } 
