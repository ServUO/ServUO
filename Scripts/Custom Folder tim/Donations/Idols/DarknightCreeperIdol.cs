...
{ 
   public class DarknightCreeperIdol : Item 
   { 
      [Constructable] 
      public DarknightCreeperIdol() : base( 9773 ) 
      { 
         Movable = true; 
         Name = "Darknight Creeper Idol"; 
      } 

      public DarknightCreeperIdol( Serial serial ) : base( serial ) 
      { 
      } 
