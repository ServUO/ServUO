...
{ 
   public class BlackSolenInfiltratorQueenIdol : Item 
   { 
      [Constructable] 
      public BlackSolenInfiltratorQueenIdol() : base( 9730 ) 
      { 
         Movable = true; 
         Name = "Black Solen Infiltrator Queen Idol"; 
         Hue = 1107;
      } 

      public BlackSolenInfiltratorQueenIdol( Serial serial ) : base( serial ) 
      { 
      } 
