...
{ 
   public class TerathanAvengerIdol : Item 
   { 
      [Constructable] 
      public TerathanAvengerIdol() : base( 9674 ) 
      { 
         Movable = true; 
         Name = "Terathan Avenger Idol"; 
      } 

      public TerathanAvengerIdol( Serial serial ) : base( serial ) 
      { 
      } 
