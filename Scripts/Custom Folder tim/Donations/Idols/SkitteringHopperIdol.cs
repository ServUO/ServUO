...
{ 
   public class SkitteringHopperIdol : Item 
   { 
      [Constructable] 
      public SkitteringHopperIdol() : base( 9762 ) 
      { 
         Movable = true; 
         Name = "Skittering Hopper Idol"; 
      } 

      public SkitteringHopperIdol( Serial serial ) : base( serial ) 
      { 
      } 
