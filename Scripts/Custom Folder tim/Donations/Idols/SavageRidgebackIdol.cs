...
{ 
   public class SavageRidgebackIdol : Item 
   { 
      [Constructable] 
      public SavageRidgebackIdol() : base( 9749 ) 
      { 
         Movable = true; 
         Name = "Savage Ridgeback Idol";  
      } 

      public SavageRidgebackIdol( Serial serial ) : base( serial ) 
      { 
      } 
