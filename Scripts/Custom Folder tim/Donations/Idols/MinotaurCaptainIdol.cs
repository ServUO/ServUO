...
{ 
   public class MinotaurCaptainIdol : Item 
   { 
      [Constructable] 
      public MinotaurCaptainIdol() : base( 6256 ) 
      { 
         Movable = true; 
         Name = "Minotaur Captain Idol"; 
      } 

      public MinotaurCaptainIdol( Serial serial ) : base( serial ) 
      { 
      } 
