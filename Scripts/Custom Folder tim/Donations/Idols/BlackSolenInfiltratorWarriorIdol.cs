...
{ 
   public class BlackSolenInfiltratorWarriorIdol : Item 
   { 
      [Constructable] 
      public BlackSolenInfiltratorWarriorIdol() : base( 9731 ) 
      { 
         Movable = true; 
         Name = "Black Solen Infiltrator Warrior Idol"; 
         Hue = 1107;
      } 

      public BlackSolenInfiltratorWarriorIdol( Serial serial ) : base( serial ) 
      { 
      } 
