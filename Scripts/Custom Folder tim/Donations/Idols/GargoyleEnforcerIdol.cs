...
{ 
   public class GargoyleEnforcerIdol : Item 
   { 
      [Constructable] 
      public GargoyleEnforcerIdol() : base( 9613 ) 
      { 
         Movable = true; 
         Name = "Gargoyle Enforcer Idol"; 
      } 

      public GargoyleEnforcerIdol( Serial serial ) : base( serial ) 
      { 
      } 
