...
{ 
   public class GiantBlackWidowIdol : Item 
   { 
      [Constructable] 
      public GiantBlackWidowIdol() : base( 9667 ) 
      { 
         Movable = true; 
         Name = "Giant Black Widow Idol"; 
      } 

      public GiantBlackWidowIdol( Serial serial ) : base( serial ) 
      { 
      } 
