...
{ 
   public class GargoyleDestroyerIdol : Item 
   { 
      [Constructable] 
      public GargoyleDestroyerIdol() : base( 9613 ) 
      { 
         Movable = true; 
         Name = "Gargoyle Destroyer Idol"; 
      } 

      public GargoyleDestroyerIdol( Serial serial ) : base( serial ) 
      { 
      } 
