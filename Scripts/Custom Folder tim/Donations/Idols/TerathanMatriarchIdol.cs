...
{ 
   public class TerathanMatriarchIdol : Item 
   { 
      [Constructable] 
      public TerathanMatriarchIdol() : base( 9675 ) 
      { 
         Movable = true; 
         Name = "Terathan Matriarch Idol"; 
      } 

      public TerathanMatriarchIdol( Serial serial ) : base( serial ) 
      { 
      } 
