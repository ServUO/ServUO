...
{ 
   public class PredatorHellCatIdol : Item 
   { 
      [Constructable] 
      public PredatorHellCatIdol() : base( 9623 ) 
      { 
         Movable = true; 
         Name = "Predator Hell Cat Idol";  
      } 

      public PredatorHellCatIdol( Serial serial ) : base( serial ) 
      { 
      } 
