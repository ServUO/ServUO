...
namespace Server.Items
{
    ...
    public class SocketableBaseTalisman : BaseArmor, IWearableDurability, IVvVItem, IOwnerRestricted, ITalismanProtection, ITalismanKiller
    {
        ...
        public SocketableBaseTalisman()
            : this(GetRandomItemID())
        {
        }

        public SocketableBaseTalisman(int itemID)
            : base(itemID)
        {
        ...
        public SocketableBaseTalisman(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            SocketableBaseTalisman talisman = newItem as SocketableBaseTalisman;
        ...
        {
            private readonly SocketableBaseTalisman m_Talisman;

            public TalismanTarget(SocketableBaseTalisman talisman)
