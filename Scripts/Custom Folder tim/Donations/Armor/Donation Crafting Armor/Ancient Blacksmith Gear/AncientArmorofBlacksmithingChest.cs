...
{
	public class AncientArmorofBlacksmithingChest : RingmailChest
	{
		...
		[Constructable]
		public AncientArmorofBlacksmithingChest()
		{
			Name = "Ancient Armor of Blacksmithing Chest";
            Hue = 1109;
			Weight = 3;
		...
		public AncientArmorofBlacksmithingChest( Serial serial ) : base( serial )
		{
		}
