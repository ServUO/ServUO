...
{
	public class AncientArmorofBlacksmithingCap : LeatherCap
	{
		...
		[Constructable]
		public AncientArmorofBlacksmithingCap()
		{
			Name = "Ancient Armor of Blacksmithing Cap";
            Hue = 1109;
			Weight = 3;
		...
		public AncientArmorofBlacksmithingCap( Serial serial ) : base( serial )
		{
		}
