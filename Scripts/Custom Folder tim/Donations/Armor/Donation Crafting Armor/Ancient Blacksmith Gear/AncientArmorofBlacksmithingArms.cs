...
{
	public class AncientArmorofBlacksmithingArms : RingmailArms
	{
		...
		[Constructable]
		public AncientArmorofBlacksmithingArms()
		{
			Name = "Ancient Armor of Blacksmithing Arms";
            Hue = 1109;
			Weight = 3;
		...
		public AncientArmorofBlacksmithingArms( Serial serial ) : base( serial )
		{
		}
