...
{
	public class AncientArmorofBlacksmithingGloves : RingmailGloves
	{
		...
		[Constructable]
		public AncientArmorofBlacksmithingGloves()
		{
			Name = "Ancient Armor of Blacksmithing Gloves";
            Hue = 1109;
			Weight = 3;
		...
		public AncientArmorofBlacksmithingGloves( Serial serial ) : base( serial )
		{
		}
