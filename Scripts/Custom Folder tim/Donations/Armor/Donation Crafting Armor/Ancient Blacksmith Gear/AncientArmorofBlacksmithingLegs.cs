...
{
	public class AncientArmorofBlacksmithingLegs : RingmailLegs
	{
		...
		[Constructable]
		public AncientArmorofBlacksmithingLegs()
		{
			Name = "Ancient Armor of Blacksmithing Legs";
			Hue = 1109;
			Weight = 3;
		...
		public AncientArmorofBlacksmithingLegs( Serial serial ) : base( serial )
		{
		}
