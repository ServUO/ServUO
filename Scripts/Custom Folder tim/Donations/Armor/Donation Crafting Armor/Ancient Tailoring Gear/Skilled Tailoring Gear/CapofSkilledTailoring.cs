...
{
    public class CapofSkilledTailoring : LeatherCap
    {
        ...
        [Constructable]
        public CapofSkilledTailoring()
        {
            Name = "Cap of Skilled Tailoring +3";
            Hue = 62;
        ...
        public override void OnRemoved(object parent)
        {
            if (parent is Mobile)
            {
                ...
                m.RemoveStatMod("CapofSkilledTailoring");
        ...
        public CapofSkilledTailoring(Serial serial)
            : base(serial)
        {
        }
