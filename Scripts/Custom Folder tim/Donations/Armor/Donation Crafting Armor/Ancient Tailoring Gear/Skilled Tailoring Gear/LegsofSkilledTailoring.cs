...
{
    public class LegsofSkilledTailoring : LeatherLegs
    {
        ...
        [Constructable]
        public LegsofSkilledTailoring()
        {
            Name = "Legs of Skilled Tailoring +3";
            Hue = 62;
        ...
        public override void OnRemoved(object parent)
        {
            if (parent is Mobile)
            {
                ...
                m.RemoveStatMod("LegsofSkilledTailoring");
        ...
        public LegsofSkilledTailoring(Serial serial)
            : base(serial)
        {
        }
