...
{
    public class ArmsofSkilledTailoring : LeatherArms
    {
        ...
        [Constructable]
        public ArmsofSkilledTailoring()
        {
            Name = "Arms of Skilled Tailoring +3";
            Hue = 62;
        ...
        public ArmsofSkilledTailoring(Serial serial) : base(serial)
        {
        }
