...
{
    public class GorgetofSkilledTailoring : LeatherGorget
    {
        ...
        [Constructable]
        public GorgetofSkilledTailoring()
        {
            Name = "Gorget of Skilled Tailoring +3";
            Hue = 62;
        ...
        public override void OnRemoved(object parent)
        {
            if (parent is Mobile)
            {
                ...
                m.RemoveStatMod("GorgetofSkilledTailoring");
        ...
        public GorgetofSkilledTailoring(Serial serial)
            : base(serial)
        {
        }
