...
{
    public class TunicofSkilledTailoring : LeatherChest
    {
        ...
        [Constructable]
        public TunicofSkilledTailoring()
        {
            Name = "Tunic of Skilled Tailoring +3";
            Hue = 62;
        ...
        public override void OnRemoved(object parent)
        {
            if (parent is Mobile)
            {
                ...
                m.RemoveStatMod("TunicofSkilledTailoring");
        ...
        public TunicofSkilledTailoring(Serial serial) : base(serial)
        {
        }
