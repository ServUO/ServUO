...
{
	public class AncientArmorofTailoringChest : RingmailChest
	{
		...
		[Constructable]
		public AncientArmorofTailoringChest()
		{
            Name = "Ancient Armor of Tailoring Chest";
			Hue = 2593;
			Weight = 3;
		...
		public AncientArmorofTailoringChest( Serial serial ) : base( serial )
		{
		}
