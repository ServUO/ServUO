...
{
	public class AncientArmorofTailoringLegs : RingmailLegs
	{
		...
		[Constructable]
		public AncientArmorofTailoringLegs()
		{
            Name = "Ancient Armor of Tailoring Legs";
			Hue = 2593;
			Weight = 3;
		...
		public AncientArmorofTailoringLegs( Serial serial ) : base( serial )
		{
		}
