...
{
	public class AncientArmorofTailoringCap : LeatherCap
	{
		...
		[Constructable]
		public AncientArmorofTailoringCap()
		{
            Name = "Ancient Armor of Tailoring Cap";
			Hue = 2593;
			Weight = 3;
		...
		public AncientArmorofTailoringCap( Serial serial ) : base( serial )
		{
		}
