...
{
	public class AncientArmorofTailoringArms : RingmailArms
	{
		...
		[Constructable]
		public AncientArmorofTailoringArms()
		{
			Name = "Ancient Armor of Tailoring Arms";
			Hue = 2593;
			Weight = 3;
		...
		public AncientArmorofTailoringArms( Serial serial ) : base( serial )
		{
		}
