...
{
	public class AncientArmorofTailoringGorget : LeatherGorget
	{
		...
		[Constructable]
		public AncientArmorofTailoringGorget()
		{
            Name = "Ancient Armor of Tailoring Gorget";
			Hue = 2593;
			Weight = 3;
		...
		public AncientArmorofTailoringGorget( Serial serial ) : base( serial )
		{
		}
