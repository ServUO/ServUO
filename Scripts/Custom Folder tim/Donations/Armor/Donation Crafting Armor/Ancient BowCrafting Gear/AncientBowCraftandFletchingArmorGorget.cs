...
{
	public class AncientBowCraftandFletchingArmorGorget : LeatherGorget
	{
		...
		[Constructable]
		public AncientBowCraftandFletchingArmorGorget()
		{
			Name = "Ancient BowCraft and Fletching Armor Gorget";
			Hue = 542;
			Weight = 3;
		...
		public AncientBowCraftandFletchingArmorGorget( Serial serial ) : base( serial )
		{
		}
