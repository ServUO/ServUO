...
{
	public class AncientBowCraftandFletchingArmorCap : LeatherCap
	{
		...
		[Constructable]
		public AncientBowCraftandFletchingArmorCap()
		{
			Name = "Ancient BowCraft and Fletching Armor Cap";
			Hue = 542;
			Weight = 3;
		...
		public AncientBowCraftandFletchingArmorCap( Serial serial ) : base( serial )
		{
		}
