...
{
	public class AncientBowCraftandFletchingArmorChest : RingmailChest
	{
		...
		[Constructable]
		public AncientBowCraftandFletchingArmorChest()
		{
			Name = "Ancient BowCraft and Fletching Armor";
			Hue = 542;
			Weight = 3;
		...
		public AncientBowCraftandFletchingArmorChest( Serial serial ) : base( serial )
		{
		}
