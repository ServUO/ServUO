...
{
	public class AncientArmorofMiningCap : LeatherCap
	{
		...
		[Constructable]
		public AncientArmorofMiningCap()
		{
			Name = "Ancient Armor of Mining Cap";
            Hue = 1141;
			Weight = 3;
		...
		public AncientArmorofMiningCap( Serial serial ) : base( serial )
		{
		}
