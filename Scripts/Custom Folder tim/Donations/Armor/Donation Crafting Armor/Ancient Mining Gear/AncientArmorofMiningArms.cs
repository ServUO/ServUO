...
{
	public class AncientArmorofMiningArms : RingmailArms
	{
		...
		[Constructable]
		public AncientArmorofMiningArms()
		{
			Name = "Ancient Armor of Mining Arms";
			Hue = 1141;
			Weight = 3;
		...
		public AncientArmorofMiningArms( Serial serial ) : base( serial )
		{
		}
