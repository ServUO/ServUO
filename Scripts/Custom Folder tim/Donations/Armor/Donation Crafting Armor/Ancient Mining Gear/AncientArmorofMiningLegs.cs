...
{
	public class AncientArmorofMiningLegs : RingmailLegs
	{
		...
		[Constructable]
		public AncientArmorofMiningLegs()
		{
			Name = "Ancient Armor of Mining Legs";
            Hue = 1141;
			Weight = 3;
		...
		public AncientArmorofMiningLegs( Serial serial ) : base( serial )
		{
		}
