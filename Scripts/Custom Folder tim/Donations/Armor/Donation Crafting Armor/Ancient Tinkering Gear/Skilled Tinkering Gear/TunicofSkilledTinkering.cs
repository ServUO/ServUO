...
{
    public class TunicofSkilledTinkering : LeatherChest
    {
        ...
        [Constructable]
        public TunicofSkilledTinkering()
        {
            Name = "Tunic of Skilled Tinkering +3";
            Hue = 702;
        ...
        public override void OnRemoved(object parent)
        {
            if (parent is Mobile)
            {
                ...
                m.RemoveStatMod("TunicofSkilledTinkering");
        ...
        public TunicofSkilledTinkering(Serial serial) : base( serial )
        {
        }
