...
{
    public class ArmsofSkilledTinkering : LeatherArms
    {
        ...
        [Constructable]
        public ArmsofSkilledTinkering()
        {
            Name = "Arms of Skilled Tinkering +3";
            Hue = 93;
        ...
        public override void OnRemoved(object parent)
        {
            if (parent is Mobile)
            {
                ...
                m.RemoveStatMod("ArmsofSkilledTinkering");
        ...
        public ArmsofSkilledTinkering(Serial serial) : base( serial )
        {
        }
