...
{
    public class LegsofSkilledTinkering : LeatherLegs
    {
        ...
        [Constructable]
        public LegsofSkilledTinkering()
        {
            Name = "Legs of Skilled Tinkering +3";
            Hue = 702;
        ...
        public override void OnRemoved(object parent)
        {
            if (parent is Mobile)
            {
                ...
                m.RemoveStatMod("LegsofSkilledTinkering");
        ...
        public LegsofSkilledTinkering(Serial serial) : base( serial )
        {
        }
