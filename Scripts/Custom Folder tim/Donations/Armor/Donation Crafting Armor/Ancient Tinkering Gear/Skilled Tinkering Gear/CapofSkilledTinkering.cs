...
{
    public class CapofSkilledTinkering : LeatherCap
    {
        ...
        [Constructable]
        public CapofSkilledTinkering()
        {
            Name = "Cap of Skilled Tinkering +3";
            Hue = 702;
        ...
        public override void OnRemoved(object parent)
        {
            if (parent is Mobile)
            {
                ...
                m.RemoveStatMod("CapofSkilledTinkering");
        ...
        public CapofSkilledTinkering(Serial serial) : base( serial )
        {
        }
