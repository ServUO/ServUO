...
{
	public class AncientArmorofTinkeringCap : LeatherCap
	{
		...
		[Constructable]
		public AncientArmorofTinkeringCap()
		{
			Name = "Ancient Armor of Tinkering Cap";
			Hue = 2593;
			Weight = 3;
		...
		public AncientArmorofTinkeringCap( Serial serial ) : base( serial )
		{
		}
