...
{
	public class AncientArmorofTinkeringLegs : RingmailLegs
	{
		...
		[Constructable]
		public AncientArmorofTinkeringLegs()
		{
			Name = "Ancient Armor of Tinkering Legs";
			Hue = 2593;
			Weight = 3;
		...
		public AncientArmorofTinkeringLegs( Serial serial ) : base( serial )
		{
		}
