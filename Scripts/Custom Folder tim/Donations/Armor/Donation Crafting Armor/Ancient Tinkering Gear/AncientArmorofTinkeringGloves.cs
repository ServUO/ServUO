...
{
	public class AncientArmorofTinkeringGloves : RingmailGloves
	{
		...
		[Constructable]
		public AncientArmorofTinkeringGloves()
		{
			Name = "Ancient Armor of Tinkering Gloves";
			Hue = 2593;
			Weight = 3;
		...
		public AncientArmorofTinkeringGloves( Serial serial ) : base( serial )
		{
		}
