...
{
	public class AncientArmorofTinkeringChest : RingmailChest
	{
		...
		[Constructable]
		public AncientArmorofTinkeringChest()
		{
			Name = "Ancient Armor of Tinkering Chest";
			Hue = 2593;
			Weight = 3;
		...
		public AncientArmorofTinkeringChest( Serial serial ) : base( serial )
		{
		}
