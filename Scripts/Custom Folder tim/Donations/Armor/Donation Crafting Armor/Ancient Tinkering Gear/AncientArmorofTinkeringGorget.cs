...
{
	public class AncientArmorofTinkeringGorget : LeatherGorget
	{
		...
		[Constructable]
		public AncientArmorofTinkeringGorget()
		{
			Name = "Ancient Armor of Tinkering Gorget";
			Hue = 2593;
			Weight = 3;
		...
		public AncientArmorofTinkeringGorget( Serial serial ) : base( serial )
		{
		}
