...
namespace Server.Mobiles
{
	...
	public class BattleChickenLizardCold : BaseCreature
	{
		[Constructable]
		public BattleChickenLizardCold() : base( AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
			Name = "-Cold Battle Lizard-";
			Body = 716;
		...
		public BattleChickenLizardCold( Serial serial ) : base( serial )
		{
		}
