...
namespace Server.Mobiles
{
	...
	public class EvilMiniontwo : BaseCreature
	{
		...
		[Constructable]
		public EvilMiniontwo() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public EvilMiniontwo( Serial serial ) : base( serial )
		{
		}
