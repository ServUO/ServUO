...
namespace Server.Items
{
	...
	public class XerxesTeleporter : Item
	{
		...
		[Constructable]
		public XerxesTeleporter() : base( 3948 )
		{
			Visible = false;
			Hue = 1;
			Movable = false;
			Weight = 0.0;
			Name = "Xerxe's Teleporter";
		}

		public XerxesTeleporter( Serial serial ) : base( serial )
		{
		}
		...
		public override bool OnMoveOver( Mobile m )
		{
			...
			if( pm.Backpack.ConsumeTotal( typeof( XerxeSkinDyes ), 1 ) )
			...
			pm.SendMessage( " You must have Xerxe's skin dyes if you wish to pass." );
			return true;
		}
