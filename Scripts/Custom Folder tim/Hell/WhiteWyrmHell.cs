...
namespace Server.Mobiles
{
	...
	public class WhiteWyrmHell : BaseCreature
	{
		[Constructable]
		public WhiteWyrmHell () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.15, 0.2 )
		{
		...
		public WhiteWyrmHell( Serial serial ) : base( serial )
		{
		}
