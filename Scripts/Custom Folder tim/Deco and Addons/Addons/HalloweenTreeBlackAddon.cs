...
{
	public class HalloweenTreeBlackAddon : BaseAddon {
		public override BaseAddonDeed Deed{get{return new HalloweenTreeBlackAddonDeed();}}
		[ Constructable ]
		public HalloweenTreeBlackAddon()
		{
		...
		public HalloweenTreeBlackAddon( Serial serial ) : base( serial ){}
		public override void Serialize( GenericWriter writer ){base.Serialize( writer );writer.Write( 0 );}
		public override void Deserialize( GenericReader reader ){base.Deserialize( reader );reader.ReadInt();}
	}

	public class HalloweenTreeBlackAddonDeed : BaseAddonDeed {
		public override BaseAddon Addon{get{return new HalloweenTreeBlackAddon();}}
		[Constructable]
		public HalloweenTreeBlackAddonDeed(){Name = "HalloweenTreeBlack";}
		public HalloweenTreeBlackAddonDeed( Serial serial ) : base( serial ){}
		public override void Serialize( GenericWriter writer ){	base.Serialize( writer );writer.Write( 0 );}
		public override void	Deserialize( GenericReader reader )	{base.Deserialize( reader );reader.ReadInt();}
	}
}