...
namespace Server.Items
{
	public class BankBox : Container
	{
		...
		{
			if (AccountGold.Enabled && AccountGold.ConvertOnBank && item != null)
			{
				if (_GoldType == null)
				{
				...
				if ((_GoldType != null && type.IsAssignableFrom(_GoldType)) || (_CheckType != null && type.IsAssignableFrom(_CheckType)))
				{
					return true;
				}
			}
